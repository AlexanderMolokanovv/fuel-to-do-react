...
Это веб-приложение для расчета характеристик топливных композиций для летательных аппаратов с использованием нейросетевых алгоритмов. Проект включает фронтенд (React) и бэкенд (Node.js с Express), обеспечивающие ввод параметров, расчет КПД топлива, дальности полета и стоимости, а также отображение результатов.
...
- `npm run dump-src` — Собирает исходный код фронтенда в текстовый файл.
- `npm run dump-serv` — Собирает исходный код бэкенда в текстовый файл.
